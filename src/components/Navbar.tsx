        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[11px] text-slate-500 -mt-0.5">Nigeria Tax Tools</div>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-2">
            ...
            <a className="px-3 py-2 rounded text-sm font-medium text-slate-700 hover:text-brand-700 hover:bg-slate-50" href="/taxguide">
              Tax Guides
            </a>
            <a className="px-3 py-2 rounded text-sm font-medium text-slate-700 hover:text-brand-700 hover:bg-slate-50" href="/about">
              About
            </a>
            <a className="px-3 py-2 rounded text-sm font-medium text-slate-700 hover:text-brand-700 hover:bg-slate-50" href="/faqs">
              FAQs
            </a>
            <a className="px-3 py-2 rounded text-sm font-medium text-slate-700 hover:text-brand-700 hover:bg-slate-50" href="/terms&conditions">
              TERMS & CONDITIONS
            </a>
          </nav>
        ...
        {mobileOpen ? (
          <div className="md:hidden border-t bg-white">
            <div className="max-w-6xl mx-auto px-4 py-3 grid gap-1">
              ...
              <NavItem to="/history" onClick={closeMobile}>History</NavItem>
