					...
					<div className="p-8 md:p-10 grid md:grid-cols-2 gap-8 items-center">
						<div>
							...
							<p className="text-white/80 mt-3 text-sm leading-relaxed max-w-lg">
								Calculate your taxes easily and accurately. Our tools help you
								understand what you owe and how it is calculated.
							</p>
						...
						<div className="h-44 md:h-56 rounded-xl bg-white/10 border border-white/10 grid place-items-center">
							<img
								src={taxlatorLanding}
								alt="Taxlator Landing"
					...
					<div className="mt-6 grid md:grid-cols-3 gap-4">
						{[
							[
								...
								"Select PAYE/PIT, VAT, Freelancer, or Company tax.",
							],
							[
								"Enter Your Income & Deductions",
								"Provide your details to generate accurate results.",
							],
							[
								"See Your Tax Breakdown Instantly",
								"Get total tax and a quick breakdown.",
							],
						].map(([t, d], i) => (
			...
			<div id="guides" className="bg-slate-100 py-10">
				<div className="max-w-6xl mx-auto px-4">
					...
					<div className="mt-6 grid md:grid-cols-3 gap-4">
						{[
							[
								"Understanding PAYE Tax bands in Nigeria",
								"A quick overview of PAYE/PIT basics.",
							],
							[
								"Tax Tips for Freelancers and Self-Employed",
								"Practical tips for self-employed taxpayers.",
							],
							[
								"What is Company Income Tax?",
								"Learn how corporate taxes are handled.",
							],
						].map(([t, d]) => (
							<div
								key={t}
					...
					<div className="mt-6 grid md:grid-cols-2 gap-4">
						{[
							[
								...
								"Built to help you understand tax outcomes clearly.",
							],
							["Instant Breakdown", "Get totals and breakdowns quickly."],
							[
								"Perfect for Workers, Students & Businesses",
								"Flexible tools for different taxpayers.",
							],
							[
								"Simple, Beautiful & Easy to Use",
								"Clean interface with reusable components.",
							],
						].map(([t, d]) => (
							<div key={t} className="rounded-2xl bg-white border p-5">
								<div className="font-semibold text-sm">{t}</div>
				...
				<div className="max-w-6xl mx-auto px-4">
					<div className="rounded-2xl bg-white p-8 text-center border">
						...
						<div className="text-sm text-slate-600 mt-2">
							Start calculating your taxes now. Creating an account enables
							tracking (optional).
						</div>
